<?php
	...
	/**
	 * Function Name: admin_notice
	 * @TODO Incorporate permalink flushing into the site.
	 */
	function admin_notice()
	{ ?>
		<div class="notice notice-success is-dismissible">
			<p>Your settings have been updated!</p>
			<p>Be sure to re-save your <a href="<?php get_admin_url(); ?>/wp-admin/options-permalink.php">permalinks</a></p>
		</div>
	<?php }
